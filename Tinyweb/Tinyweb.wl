...
WebSocketSend[cli_, exp_] := BinaryWrite[SocketObject[cli], constructReply[ExportString[exp,"ExpressionJSON", "Compact" -> 0]]];
...
WebSocketBroadcast[WEBServer[server_Symbol?AssociationQ], exp_] := With[
    ...
    BinaryWrite[SocketObject[#], constructReply[ExportString[exp,"ExpressionJSON", "Compact" -> 0]]]& /@ clients;
